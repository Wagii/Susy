...
public class GetEventInstanceWaveData : DataGetter {
	...
	private System.Collections.IEnumerator WaitForInstanceInitialization() {
		...
		while (ptr.data != true) {
			FMODGetSpectrum.CheckEventInstantiated(eventInstance, ptr);
			yield return null;
		}
		FMODGetSpectrum.StartVisualizeEvent(eventInstance, fft);
