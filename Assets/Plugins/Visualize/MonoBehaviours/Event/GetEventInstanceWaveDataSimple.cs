...
public class GetEventInstanceWaveDataSimple : DataGetter {
	...
	private Coroutine visualizeUpdate = null, waitForInstanceInitialization = null;
	...
	protected void Awake() {
		...
		this.waitForInstanceInitialization = StartCoroutine(WaitForInstanceInitialization());
		this.visualizeUpdate = StartCoroutine(VisualizeUpdate());
	}

	public void ResetInstance() {
		StopCoroutine(this.waitForInstanceInitialization);
		StopCoroutine(this.visualizeUpdate);
		this.waitForInstanceInitialization = StartCoroutine(WaitForInstanceInitialization());
		this.visualizeUpdate = StartCoroutine(VisualizeUpdate());
	}
	...
	private System.Collections.IEnumerator WaitForInstanceInitialization() {
		...
		StartCoroutine(FMODGetSpectrum.WaitAndVisualize(instanceReference.eventInstance, fft));
	}
