...
namespace ScriptInspector.Themes
{
	...
	[InitializeOnLoad]
	public class CustomMonokai
	{
		private static string _themeName = "Custom Monokai";
		
		static CustomMonokai()
		{
		...
		public static Theme _colourTheme = new Theme
		{
			...
			namespaces              = new Color32(112, 112, 184, 255),
			methods                 = new Color32(84, 182, 127, 255),
